...
kds_note = (
    "Bu bölümde Atatürk Mahallesi pilot bölgesi için 15:00-23:00 operasyon "
    "penceresinde AVG ve AZU araçlarıyla oluşturulan GA tabanlı rota sonucu "
    "özetlenmiştir. Belediye referans rotası farklı mahalleleri de içerdiğinden, "
    "bu aşamada doğrudan maliyet karşılaştırması yapılmamıştır."
)
...
with open(
    os.path.join(kds_output_folder, "kds_note.txt"),
    "w",
    encoding="utf-8"
) as file:
    file.write(kds_note)
